(function () {
    ...
    sap.ui.define(["sap/ui/model/SimpleType", "sap/ui/model/ValidateException"], function (
        ...
        return SimpleType.extend("swd.fair.consumerFriendly.util.types.Mobile", {
            ...
            validateValue: function (sValue) {
                if (sValue && !sValue.match(/^(0{1})[0-9]{0,27}\b/gm))
                    throw new ValidateException(`Mobilnummer muss mit 0 anfangen und darf maximal 28 Ziffern enthalten`);
            }
        });
    });
})();